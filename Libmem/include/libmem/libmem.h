...
LM_EnumProcesses(lm_bool_t (LM_CALL *callback)(lm_process_t *pproc,lm_void_t *arg), lm_void_t *arg);
...
LM_API lm_bool_t LM_CALL
LM_EnumSymbols(const lm_module_t  *pmod,lm_bool_t (LM_CALL *callback)(lm_symbol_t *psymbol,lm_void_t   *arg),lm_void_t          *arg);
